...
#if defined(TANGRAM_LINUX) || defined(TANGRAM_WINDOWS) || defined(TANGRAM_WXWIDGETS)
#define GL_GLEXT_PROTOTYPES
#endif // defined(TANGRAM_LINUX) || defined(TANGRAM_WINDOWS) || defined(TANGRAM_WXWIDGETS)
